...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng iitr = new LatLng(29.86, 77.89);
        mMap.addMarker(new MarkerOptions().position(iitr).title("Marker in IIT Roorkee"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(iitr));
    }
